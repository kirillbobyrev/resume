...
\section{Experience}
  \cventry{2019}{Data Scientist}{Dbrain}{}{}{
    Developed Deep Learning models for various computer vision tasks including
    image classification, forgery detection and object segmentation using
    PyTorch, implemented Machine Learning pipelines starting from raw data and
    producing necessary predictions on par with state-of-the-art scientific
    results.}
...
\section{Skills}
  \cvdoubleitem{Languages}{Modern C++ (C++20), Python, Go}{Expertise}{Compilers,
    Deep Learning}
  \cvdoubleitem{Technologies}{LLVM, PyTorch, TensorFlow}{}{}
