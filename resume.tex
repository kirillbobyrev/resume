...
\section{Projects}
  \cventry{2018--Present}{Suanni}{Prototyping in Progress}{}{}{Implementing
    \texttt{bc}-compatible arbitrary precision calculator in Rust}
...
\section{Skills}
  ...
  \cvitem{Libraries}{LLVM, NumPy, SciPy, TensorFlow, Scikit-Learn}
  \cvitem{Research Interests}{Convex Optimization, Optimizing Compilers,
                              Static Analysis}
