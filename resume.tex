  ...
  \cventry{2018--Present}{Software Engineering Intern}
    ...
    {Working on ClangD, Clang-based C++ Language Server Protocol implementation.
     \begin{itemize}
       ...
       \item Boosted the quality and performance of symbol search by designing
         and applying index optimizations
       \item Profiled commonly used LLVM YAML serializer and made it up to
         2.5x faster
         tool and optimized it
       \item Extended benchmarks infrastructure in LLVM
     \end{itemize}}
