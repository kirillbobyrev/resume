...
\section{Experience}
  ...
  \cventry{2016}{Software Engineering
    Intern}{Google}{Munich}{C++ Language Tools Team}{
    \begin{itemize}%
      \item Fixing a number of existing issues, introducing new functionality
        and gaining users for clang-rename
...
\section{Projects}
  ...
  \cventry{2016}{VisARTM}{}{}{}{Created Topic Model navigator for NLP framework
    under supervision of K.V. Vorontsov}
...
\section{Skills}
  ...
  \cvitem{Languages}{Russian (native), English (fluent), German
