  ...
  \cventry{2018--Present}{Software Engineering Intern}
    ...
    {Working on ClangD, Clang-based C++ Language Server Protocol implementation.
     \begin{itemize}
       ...
       \item Profiled commonly used LLVM YAML serializer and making it up to
         2.5x faster
       \item Identified performance bottlenecks of global symbol index builder
         tool and optimizing it
       \item Constructed benchmarks infrastructure in LLVM
     \end{itemize}}
  \cventry{2016}{Software Engineering
    Intern}{Google}{}{C++ Language Tools Team}{\begin{itemize}
