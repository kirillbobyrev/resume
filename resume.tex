...
\section{Experience}
  ...
  \cventry{2015}{Google Summer of Code student}{LLVM
    ...
    \href{https://github.com/omtcvxyz/code-clone-detection-llvm-devmtg15-poster\#code-clone-detection-llvm-devmtg15-poster}{\textcolor{blue}{here}}}
...
\section{Projects}
  \cventry{2018--Present}{Heathen}{Prototyping in progress}
    ...
    {Designing and implementing a text editor for personal usage}
  \cventry{2018--Present}{$\texttt{TD}(\gamma)$}{}
    {\url{https://github.com/omtcvxyz/td-gamma}}{}
