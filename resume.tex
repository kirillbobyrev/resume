...
\section{Education}
  \cventry{Class of 2019}{Bachelor of Science}{Moscow, Russia}{Moscow Institute
    ...
    {Relevant Coursework: Stochastic and Convex Optimization, Linear Algebra,
     Machine Learning, Probability Theory and Statistics, Theory and
     Implementation of Programming Languages, Functional Analysis, Advanced
     Calculus, Parallel Computing, Quantum Mechanics.}
