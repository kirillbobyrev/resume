  ...
  \cventry{2018}{Software Engineering Intern}
    ...
    {Working on Clangd, Clang-based C++ Language Server Protocol implementation.
     \begin{itemize}
       ...
       \item Replaced previous Static Index implementation and gained up to
         15-35x boost while providing more features for code completion-based
         symbol search.
       \item Implemented Variable Byte compression to reduce symbol index
         memory consumption.
       \item Identified performance bottlenecks in commonly used LLVM YAML
         serializer and improved performance by a factor of 3.
       \item Extended Clangd infrastructure by constructing benchamrks and
         building index exploration tool.
     \end{itemize}}
