...
\section{Education}
  \cventry{Class of 2019}{Bachelor of Science}{Moscow, Russia}{Moscow Institute
    ...
    {Relevant Coursework: Stochastic and Convex Optimization, Linear Algebra,
     Probability Theory and Statistics, Theory and Implementation of Programming
     Languages, Functional Analysis, Advanced Calculus, Parallel Scientific
     Computing, Kolmogorov Complexity, Quantum Mechanics.}

\section{Experience}
  \cventry{2018--Present}{Software Engineering Intern}
    {Google}{Munich}{}
    {Working on ClangD --- the C++ Language Server Protocol implementation based
    on Clang.}
