...
\section{Experience}
  ...
  \cventry{2015}{Google Summer of Code student}{LLVM
    ...
    \href{https://github.com/kbobyrev/code-clone-detection-llvm-devmtg15-poster\#code-clone-detection-llvm-devmtg15-poster}{\textcolor{blue}{overview}}
    of key results.}
...
\section{Skills}
  \cvitem{Programming}{Modern C++ (C++20), Python, Haskell}
  \cvitem{Languages}{English, Russian, German}
