...
\begin{cventries}
  ...
  \cventry
	...
	{https://blog.waymo.com/2021/06/SimulationCity.html}: Waymo's most
        ...
        \item Migrated a critical Neural Network component from CPU to TPU and
  ...
  \cventry
    ...
    {Nov 2019 - Jun 2022}
    {
	  ...
	  other IDEs and text editors.
        \item Designed and implemented \link{Include Cleaner}{https://clangd.llvm.org/
          design/include-cleaner}: \link{IWYU}{https://include-what-you-
          use.org/}-like functionality for warning users about unused and
          missing headers.
