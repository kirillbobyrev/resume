...
\begin{cventries}
  ...
  \cventry
    ...
    {
      \begin{cvitems}
        \item Working on \link{Simulation
        City}{https://blog.waymo.com/2021/06/SimulationCity.html}: Waymo's most
    ...
    {Nov 2019 - Jun 2022}
    {
      \begin{cvitems}
        ...
        \item Designed and implemented IncludeCleaner:
          \link{IWYU}{https://include-what-you-use.org/}-like functionality in
          clangd for warning users about unused and missing headers.
        \item Implemented \link{Remote Index
          service}{https://clangd-index.llvm.org/} for LLVM and Chrome. This
    ...
    {Feb 2019 - Jun 2019}
    {
      \begin{cvitems}
        \item Secured a contract with AMG Mercedes Benz, worked out how to
          ...
          and led the project of generating insights from provided data.
