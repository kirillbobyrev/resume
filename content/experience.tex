...
\begin{cventries}
  ...
  \cventry
    ...
    {
      \begin{cvitems}
        \item Worked on \link{Clangd}{https://clangd.llvm.org/}, Clang-based
  ...
  \cventry
    {Data Scientist}
    {Handl, \link{Y Combinator}{https://www.ycombinator.com/}-backed Machine
     Learning startup}
    {}
    {Feb 2019 - Jun 2019}
    {
    ...
    {Jul 2018 - Sep 2018}
    {
      \begin{cvitems}
        \item Designed and implemented
          ...
          based on Russ Cox
          \link{design}{https://swtch.com/~rsc/regexp/regexp4.html} of Google Code
          Search.
